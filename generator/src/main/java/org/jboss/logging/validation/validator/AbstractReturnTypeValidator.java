 ...
 */
abstract class AbstractReturnTypeValidator implements ElementValidator {
    private final Types typeUtil;

    protected AbstractReturnTypeValidator(final Types typeUtil) {
     ...
     */
    protected final Collection<ValidationMessage> checkExceptionConstructor(final ExecutableElement method) {

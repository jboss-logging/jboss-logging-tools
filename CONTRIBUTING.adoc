...
Want to contribute to the jboss-logging-tools? We try to make it easy, and all contributions, even the smaller ones,
...
All original contributions to jboss-logging-tools are licensed under the
...
jboss-logging-tools has a strictly enforced code style. Code formatting is done by the Eclipse code formatter, using the config files
